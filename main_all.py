...
NORMAL_MARKET_DATES = [
    # --- 2023年 Q4 (常规淡季与周末) ---
    {'date': '2023-09-08', 'case_study_movie': None}, # 周五：新片上映
    {'date': '2023-09-16', 'case_study_movie': None}, # 周五：国庆前夕
    {'date': '2023-10-18', 'case_study_movie': None}, # 周三：国庆后冷淡期
    {'date': '2023-10-27', 'case_study_movie': None}, # 周五
    {'date': '2023-11-02', 'case_study_movie': None}, # 周四
    {'date': '2023-11-10', 'case_study_movie': None}, # 周五：双11档期
    {'date': '2023-11-14', 'case_study_movie': None}, # 周二
    {'date': '2023-11-26', 'case_study_movie': None}, # 周日
    {'date': '2023-12-15', 'case_study_movie': None}, # 周五

    # --- 2024年 Q1 (春节前后冷淡期) ---
    {'date': '2024-01-09', 'case_study_movie': None}, # 周二：元旦后
    {'date': '2024-01-16', 'case_study_movie': None}, # 周三
    {'date': '2024-02-22', 'case_study_movie': None}, # 周四：春节后回落
    {'date': '2024-02-27', 'case_study_movie': None}, # 周二
    {'date': '2024-03-01', 'case_study_movie': None}, # 周五：后春节档新片
    {'date': '2024-03-20', 'case_study_movie': None}, # 周三：典型冷门期
    {'date': '2024-03-29', 'case_study_movie': None}, # 周五

    # --- 2024年 Q2 (春季常规档) ---
    {'date': '2024-04-12', 'case_study_movie': None}, # 周五
    {'date': '2024-04-24', 'case_study_movie': None}, # 周三：五一前夕
    {'date': '2024-05-14', 'case_study_movie': None}, # 周二：五一后
    {'date': '2024-05-24', 'case_study_movie': None}, # 周五
    {'date': '2024-06-19', 'case_study_movie': None}, # 周三：618后
    {'date': '2024-06-28', 'case_study_movie': None}, # 周五：暑期前奏

    # --- 2024年 Q3 (暑期平日与9月) ---
    {'date': '2024-07-17', 'case_study_movie': None}, # 周三
    {'date': '2024-07-25', 'case_study_movie': None}, # 周四
    {'date': '2024-08-06', 'case_study_movie': None}, # 周二
    {'date': '2024-08-20', 'case_study_movie': None}, # 周二：黑神话悟空发售日(流量波动)
    {'date': '2024-08-30', 'case_study_movie': None}, # 周五：开学季
    {'date': '2024-09-04', 'case_study_movie': None}, # 周三
    {'date': '2024-09-13', 'case_study_movie': None}, # 周五：中秋前
    {'date': '2024-09-24', 'case_study_movie': None}, # 周二：国庆前冷淡
]

# ==============================================================================
# 2. 热门档期 (Holiday Market) - 覆盖所有法定节假日 (约40个)
# ==============================================================================
# ==============================================================================
# 2. 热门档期 (Holiday Market)
# ==============================================================================
HOLIDAY_MARKET_DATES = [
    # --- 2023 国庆档 (选取首日、国庆正日、中段、尾声) ---
    {'date': '2023-09-30', 'case_study_movie': None}, # 假期首日
    {'date': '2023-10-01', 'case_study_movie': None}, # 国庆节当天(流量峰值)
    {'date': '2023-10-04', 'case_study_movie': None}, # 假期中段(口碑分化期)
    # --- 2024 元旦档 (选取跨年夜与首日) ---
    {'date': '2024-01-01', 'case_study_movie': None}, # 新年第一天
    # --- 2024 春节档 (选取初一、初三、初五、初八) ---
    {'date': '2024-02-10', 'case_study_movie': None}, # 正月初一(最强爆发日)
    {'date': '2024-02-14', 'case_study_movie': None}, # 初五 + 情人节(双重加成)
    {'date': '2024-02-17', 'case_study_movie': None}, # 初八(假期最后一天，撤档高发期)
    # --- 2024 五一档 (选取首、中、尾) ---
    {'date': '2024-05-03', 'case_study_movie': None}, # 假期中段
    {'date': '2024-05-05', 'case_study_movie': None}, # 假期收官
    # --- 2024 端午档 (选取首尾) ---
    {'date': '2024-06-9', 'case_study_movie': None}, # 端午节正日
    # --- 2024 暑期档高峰 (选取7-8月最热的几个周六/特殊日) ---
    {'date': '2024-07-20', 'case_study_movie': None}, # 暑期流量高峰
    {'date': '2024-07-27', 'case_study_movie': None}, # 死侍上映周六
    {'date': '2024-08-04', 'case_study_movie': None}, # 8月初周日
    {'date': '2024-08-10', 'case_study_movie': None}, # 七夕节(特殊单日高峰)
    {'date': '2024-08-17', 'case_study_movie': None}, # 异形/重生上映周六
...
def main_black_horse():
    ...
    log_dir = os.path.join("logs", "main_all")
